...
def main():
    ...
    # For this example, assuming you have a session available
    session = SessionLocal()
    db_manager = DatabaseManager(session)
    
    input_dir = "D:\\NExnora\\Farmacy_v1\\FarmacyBackend\\app\\sample_translate\\db_inputs_final"
    
    try:
        # # Process crops
        # logger.info("Processing crops...")
        # crops_data = load_json_file(f"{input_dir}/crop_inputs.json")
        # for crop_data in crops_data:
        #     db_manager.add_or_update_crop(crop_data)

        # # Process stages
        # logger.info("Processing crop stages...")
        # stages_data = load_json_file(f"{input_dir}/stage_inputs.json")
        # for stage_data in stages_data:
        #     db_manager.add_or_update_crop_stage(stage_data)

        # # Process weeks
        # logger.info("Processing crop weeks...")
        # weeks_data = load_json_file(f"{input_dir}/week_inputs.json")
        # for week_data in weeks_data:
        #     db_manager.add_or_update_crop_week(week_data)

        # # Process diseases
        # logger.info("Processing diseases...")
        # diseases_data = load_json_file(f"{input_dir}/disease_inputs.json")
        ...
        crop_diseases_data = load_json_file(f"{input_dir}/crop_disease_inputs.json")
